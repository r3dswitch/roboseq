...
from roboseq.algorithms.marl.utils.separated_buffer import SeparatedReplayBuffer
from roboseq.utils.util import update_linear_schedule
...
class Runner:
    def __init__(self, vec_env, config, model_dir=""):
        ...
        if self.algorithm_name == "happo":
            from roboseq.algorithms.marl.happo_trainer import HAPPO as TrainAlgo
            from roboseq.algorithms.marl.happo_policy import HAPPO_Policy as Policy
        if self.algorithm_name == "hatrpo":
            from roboseq.algorithms.marl.hatrpo_trainer import HATRPO as TrainAlgo
            from roboseq.algorithms.marl.hatrpo_policy import HATRPO_Policy as Policy
        if self.algorithm_name == "mappo":
            from roboseq.algorithms.marl.mappo_trainer import MAPPO as TrainAlgo
            from roboseq.algorithms.marl.mappo_policy import MAPPO_Policy as Policy
