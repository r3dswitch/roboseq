...
from roboseq.algorithms.offrl.td3_bc import TD3_BC_Model
from roboseq.algorithms.offrl.td3_bc import ReplayBuffer
...
class TD3_BC:
    def __init__(
        ...
        self.algo = algo
        self.log_dir = (
            self.log_dir.split(self.algo)[0] + self.algo + "/" + self.datatype + "/"
        )
        self.data_dir = self.log_dir.split(self.algo)[0].split("logs")
        self.data_dir = (
            self.data_dir[0] + "data" + self.data_dir[1] + self.datatype + "/"
        )
