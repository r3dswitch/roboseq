...
class ReplayBuffer:
    def __init__(
        ...
        self.observations = torch.zeros(
            replay_size, num_envs, *obs_shape, device=self.device
        )
        self.states = torch.zeros(
            replay_size, num_envs, *states_shape, device=self.device
        )
        ...
        self.actions = torch.zeros(
            replay_size, num_envs, *actions_shape, device=self.device
        )
