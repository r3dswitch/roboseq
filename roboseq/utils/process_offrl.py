def process_td3_bc(args, env, cfg_train, logdir):
    from roboseq.algorithms.offrl.td3_bc import TD3_BC
...
def process_bcq(args, env, cfg_train, logdir):
    from roboseq.algorithms.offrl.bcq import BCQ
...
def process_iql(args, env, cfg_train, logdir):
    from roboseq.algorithms.offrl.iql import IQL
...
def process_ppo_collect(args, env, cfg_train, logdir):
    from roboseq.algorithms.offrl.ppo_collect import PPO, ActorCritic
