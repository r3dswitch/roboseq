...
from roboseq.utils.config import (
    set_np_formatting,
    set_seed,
    get_args,
    parse_sim_params,
...
from roboseq.utils.parse_task import parse_task
from roboseq.utils.process_sarl import *
from roboseq.utils.process_marl import process_MultiAgentRL, get_AgentIndex
from roboseq.utils.process_mtrl import *
from roboseq.utils.process_metarl import *
import os
...
# from roboseq.utils.rl_games_custom import
...
if __name__ == "__main__":
    ...
    with open(config_name, "r") as stream:
        ...
        rlgames_cfg["params"]["config"]["minibatch_size"] = (
            rlgames_cfg["params"]["config"]["minibatch_size"] * env.num_environments
        )
